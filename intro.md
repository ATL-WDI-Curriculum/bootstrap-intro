...
[Mike Codepen Bootstrap 3 Grid System](http://codepen.io/drmikeh/pen/xbLgOM?editors=110)
...
Let's download the sample app.

1. Goto the Bootstrap homepage (http://getbootstrap.com/) and click on "Download Bootstrap".
2. Open the `.zip` file. 
3. Drag the folder to your `~/ga/wdi` directory. 
4. In Terminal, `cd` into the folder.
5. `touch index.html` to create an `index.html` file 
6. Open the directory in Atom/Sublime.
7. Click on the Getting Started - Examples Framework section here: http://getbootstrap.com/getting-started/#examples-framework
...
**If you finish your assignments, check out the documentation for Materialize (http://materializecss.com/).** Try to set up a basic starter page like we did with Bootstrap.


Each group should create a demo (Codepen is fine) of at least one of their components and write up the answers to the following questions for each:
